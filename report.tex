...
[1ex] \large by Patrick O’Reilly, Julia Barnett, Hugo Flores Garcia, Annie Chu, \\
Nathan Pruyne, Prem Seetharaman, Bryan Pardo}

\author{Synthesis by Gabriel Tardiou}% <-this % stops a space}

\IEEEtitleabstractindextext{%
  % Note that keywords are not normally used for peerreview papers.
  \begin{IEEEkeywords}
    Music Information Retrieval, Audio Generation, Drum Synthesis, Artificial Intelligence, Transformer, Masked Language Modeling
  \end{IEEEkeywords}}
...
The work from Patrick O'Reilly et al. falls within the Music Information Retrieval discipline, which is the science of processing music information. It was presented at ISMIR 2025 conference.
...
Many people naturally express rhythms by beatboxing or tapping on a table, practices that are both intuitive and extremely popular.
Being able to turn these simple audio gestures into realistic drum sounds could make TRIA a valuable tool for music creation, notation, and composition.
...
The article focuses on how the dualization of rhythm and timbre allows the model to give better synthesizations. This means TRIA is able to separate what rhythm is played from how it sounds.
...
At the time of publishing of this article, MelodyFlow by Lan et al.~\cite{lan2024melodyflow} is the most recent model with a lot of influence in music generation models.
...
This had a big influence on Music Information Retrieval and music generation because it shows the importance of timings and dynamics.
...
The authors divide their contribution into three separate parts.
...
\begin{figure}[t]
  \centering
  \includegraphics[width=\linewidth]{images/output_example.png}
  \caption{Example of TRIA combining rhythm and timbre prompts, from https://therhythminanything.github.io/.}
  \label{fig:tria-example}
\end{figure}
...
The aim is to encode correctly the rhythmic structure given in input and avoid leaking timbre information.
...
The state-of-the-art model used is MelodyFlow, which takes as input an audio prompt of the desired rhythm - sound gestures just like for TRIA, and a text prompt of the desired timbre.
...
Out of the hundred and twenty people originally recruited, a hundred and sixteen passed the listening test and went on with the evaluation of the audios.
...
The example shown in Figure~\ref{fig:tria-example} illustrates how TRIA combines a rhythm prompt and a separate timbre prompt to generate a new drum sound, highlighting its ability to disentangle rhythmic structure from sound texture.

\section{Discussion}\label{sec:discussion}

We find this model contributes significantly to Music Information Retrieval - MIR.
...
For composers or musicians who want to create drum tracks quickly to not lose their inspiration, this model is a great tool to have, very easy to use and it produces great results.

From a drummer's point of view, I appreciate the effort the authors put in assessing audio quality.
Compared to other models, I find TRIA more precise.
The kick, snare, and hi-hat placements are well determined by the model and well correspond to the original rhythm.
