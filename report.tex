...
RAVE~\cite{caillon2021rave} is an other model the authors took their inspiration from.
...
TRIA was trained and evaluated on audio rhythm prompts taken from two datasets: Amateur Vocal Percussion - AVP~\cite{delgado2019avp}, and TapTamDrum~\cite{haki2023taptamdrum}, as well as MoisesDB dataset for timbre prompts.

AVP is a dataset compiling beatboxing improvization recordings from twenty-eight amateurs.
...
Out of the a hundread and twenty persons originally recruited, a hundread and sixteen passed the listening test and went on with the evaluation of the audios.
